...
This is a backend coding exercise based on [Nest](https://github.com/nestjs/nest) framework TypeScript starter project.
...
* NestJS is run within Docker as well, port 3000 mapped to the local system 3000 
